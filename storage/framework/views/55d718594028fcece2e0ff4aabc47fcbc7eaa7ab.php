...
<?php $__env->startSection('menu'); ?>
    <?php echo $__env->make('frontend.menu_others', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('footer_menu'); ?>
    <?php echo $__env->make('frontend.others_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="breadcrumb-wrapper">
        <div class="container">
            <div class="row g-4 align-items-center">
                <h2 class="mb-0"><?php echo app('translator')->get('index.login'); ?></h2>
                <ol class="breadcrumb mb-0 justify-content-center">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo app('translator')->get('index.home'); ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <?php if(urlPrefix() == 'admin'): ?>
                            <?php echo app('translator')->get('index.login_as_admin'); ?>
                        <?php elseif(urlPrefix() == 'agent'): ?>
                            <?php echo app('translator')->get('index.login_as_agent'); ?>
                        <?php elseif(urlPrefix() == 'customer'): ?>
                            <?php echo app('translator')->get('index.login_as_customer'); ?>
                        <?php endif; ?>
                    </li>
                </ol>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 left-col">
                    <div class="top_text">
                        ...
                        <p class="sub-text"><?php echo app('translator')->get('index.login_account'); ?></p>
                    </div>
                    ...
                    <form action="<?php echo e(route('user-login')); ?>" method="POST" id="login_form">
                        ...
                        <div class="alert alert-<?php echo e(Session::get('type') ?? 'danger'); ?>">
                            <span><?php echo e(Session::get('message')); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(Session::has('resend-message')): ?>
                        <div class="alert alert-info">
                            <span><?php echo e(Session::get('resend-message')); ?></span>
                            <a href="<?php echo e(route('resend-link', Session::get('email'))); ?>"><?php echo app('translator')->get('index.resend_verification_link'); ?></a>
                        </div>
                    <?php endif; ?>
                        <div class="row login-row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="email"><?php echo app('translator')->get('index.email'); ?> <span class="text-danger">*</span></label>
                                    <div>
                                        <div class="position-relative">
                                            <input name="email" value="<?php echo e(getDemoAccess(1)); ?>" type="email"
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo app('translator')->get('index.email_placeholder'); ?>">
...
unset($__errorArgs, $__bag); ?>                                        
                            ...
                            <div class="col-12">
                                <div class="form-group password-sec">
                                    <label for="password"><?php echo app('translator')->get('index.password'); ?> <span class="text-danger">*</span></label>
                                    <div>
                                        <div class="position-relative">
                                            <input name="password" type="password"
                                                class="form-control password-field-for-js <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo app('translator')->get('index.password_placeholder'); ?>" value="<?php echo e(getDemoAccess(2)); ?>">
                                            ...
                                            <img src="<?php echo e(asset('assets/frontend/img/core-img/password.svg')); ?>" alt=""
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary w-100 padding-12">
                                    <?php echo app('translator')->get('index.login'); ?>
                                </button>
                            </div>
                            <div class="row">  
                                <div class="col-12 col-md-12">
                                    <div class="text-center">
                                        <a href="<?php echo e(route('reset-password-step-one')); ?>">
                                            <?php echo app('translator')->get('index.forgot_password'); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="register-divider-wrapper-wrapper">
                            <div class="register-divider-wrapper">
                                <p class="register-divider d-block">
                                    <span><?php echo app('translator')->get('index.or'); ?></span>
                                </p>
                                <div class="others-login">
                                    <div class="row g-4">
                                        <?php if(socialInfo() && socialInfo()['envato_login'] == 'Active'): ?>
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <a class="btn btn-envato d-block social_btn"
                                                    href="<?php echo e(url('auth/envato')); ?>">
                                                    ...
                                                    <?php echo app('translator')->get('index.login_with_envato'); ?>
                                                </a>
                                            </div>
                                        <?php endif; ?>
                                        <?php if(socialInfo() && socialInfo()['google_login'] == 'Active'): ?>
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <a class="btn btn-google d-block social_btn"
                                                    ...
                                                    <?php echo app('translator')->get('index.login_with_google'); ?>
                                                </a>
                                            </div>
                                        <?php endif; ?>
                                        <?php if(socialInfo() && socialInfo()['github_login'] == 'Active'): ?>
                                            <div class="col-12 col-sm-12 col-md-12">
                                                <a class="btn btn-github d-block social_btn"
                                                    href="<?php echo e(url('auth/github')); ?>">
                                                    <svg width="28" height="28" viewBox="0 0 28 28"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <?php echo app('translator')->get('index.login_with_github'); ?>
                                                </a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                            ...
                            <!-- Divider -->
                            <p class="mb-0 text-center register-text"><?php echo app('translator')->get('index.no_account'); ?> <a
                                    href="<?php echo e(route('register')); ?>"><?php echo app('translator')->get('index.create_account'); ?> </a>
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="login-image rounded-4 mt-5">
                        <?php if(urlPrefix() == 'admin'): ?>
                            <img class="rounded-4" src="<?php echo e(asset('assets/frontend/img/core-img/customer-login-bg.svg')); ?>"
                                alt="">
                        <?php elseif(urlPrefix() == 'agent'): ?>
                            <img class="rounded-4" src="<?php echo e(asset('assets/frontend/img/core-img/customer-login-bg.svg')); ?>"
                                alt="">
                        <?php elseif(urlPrefix() == 'customer'): ?>
                            <img class="rounded-4"
                                src="<?php echo e(asset('assets/frontend/img/core-img/customer-login-bg.svg')); ?>" alt="">
                        <?php endif; ?>
...
<?php echo $__env->make(layout(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u209993987/domains/opnium.com/public_html/rabbit/resources/views/frontend/login.blade.php ENDPATH**/ ?>