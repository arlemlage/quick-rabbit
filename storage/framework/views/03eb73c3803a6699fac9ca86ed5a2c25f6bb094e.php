<div class="offcanvas offcanvas-end" data-bs-scroll="false" tabindex="-1" id="offcanvas_right_button"
    ...
    <div class="offcanvas-body">
        <a class="mb-4 d-block canvas-logo" href="<?php echo e(route('home')); ?>">
            <img loading="lazy" src="<?php echo e(asset(siteSetting()->logo)); ?>" alt="">
        </a>
        <p class="canvas-text"><?php echo e(siteSetting()->footer_text ?? ''); ?></p>
        <h4 class="canvas_inter_title"><?php echo app('translator')->get('index.get_in_touch'); ?></h4>
        <div class="footer-contact-info">            
            ...
            <div class="address-info">
                ...
                <span><?php echo e(siteSetting()->address ?? ''); ?></span>
            </div>
        </div>
        <h4 class="canvas_inter_title mt-4"><?php echo app('translator')->get('index.need_more_help'); ?></h4>
        <div class="subscribe-form">
            <form action="#" method="post" class="offcanvas-body-form">
                <input type="text" class="form-control email_subscribe_off_canvas" placeholder="<?php echo app('translator')->get('index.enter_your_email'); ?>" aria-label="Enter your email">
...
<?php /**PATH /home/u209993987/domains/opnium.com/public_html/rabbit/resources/views/frontend/__offcanvas_header.blade.php ENDPATH**/ ?>